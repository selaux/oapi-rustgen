...
impl<'de> serde::de::Deserialize<'de> for AdditionalProperties {
...
impl serde::ser::Serialize for AdditionalProperties {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        match self {
            AdditionalProperties::None => false.serialize(serializer),
